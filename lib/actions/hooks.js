...
// usage : curl "http://core-slackbot.herokuapp.com/hooks/gasi/df9e5ec3455f9dfe0480d83e8ace0caf548b302d036bc95bc4c6b1f74d8db802?msg=fail&buildResultsUrl=${bamboo.buildResultsUrl}"                                                
    ...
    .then(match => {
      ...
      Object.keys(bots).forEach(key => {
        ...
        if (match.message.team === bot.team_info.id) {
          ...
          const replyMessage = `<${hookToUrl(match.name)}|hook triggered>:${inputMsg} <${buildResultsUrl}|open url>`;
